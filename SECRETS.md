...
- PLAID_CLIENT_ID — *describe*
- PLAID_SECRET — *describe*
- PLAID_ENV — *describe*
- FIDELITY_USER — *describe*
- FIDELITY_PIN — *describe*
- FIDELITY_ACCOUNT_ID — *describe*
- ENCRYPTION_KEY — *describe*
- DASHBOARD_PIN — *describe*
- DATABASE_URL — *describe*
- SYNC_INTERVAL_HOURS — *describe*
- BACKEND_URL — *describe*
- APP_BASE_URL — *describe*
